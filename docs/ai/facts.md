# docs/ai/facts.md — Fatos canônicos (fonte única para números e datas)

> Fonte única de verdade para qualquer fato biográfico/de carreira citado no site. Se um número
> aqui está marcado como "a confirmar", **nenhuma página do site deve publicá-lo sem essa mesma
> ressalva**. Qualquer mudança em datas, cargos ou métricas de carreira deve ser aplicada primeiro
> aqui e só depois replicada em `sobre.html` / `en/sobre.html`.
...
enquanto já assumia o cargo de CTO na Aurum.

## Números — **a confirmar** (não publicar sem ressalva)

- Crescimento de receita da Aurum durante a gestão como CTO: descrito como "quase dobrou" /
  "nearly doubled".
- Crescimento da base de clientes da Aurum: descrito como "quase dobrou" / "nearly doubled".
...
- B.S., Sistemas de Informação — Universidade Federal de Minas Gerais (UFMG), 2008–2012.
- Especializações informais: UX Engineering, Front-End Development, gestão operacional/de processos.
